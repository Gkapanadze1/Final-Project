            ...
            <section className='w-full flex items-center gap-16' style={{ backgroundColor: '#FFF', paddingBottom: '150px' }}>
                ...
                <div className='border-s p-20'>
                    ...
                    <div className="flex justify-between items-center mb-12">
                        ...
                        <div></div>
                        <Link to="/cart"><button className='flex items-center justify-center border border-slate-400 w-[107px] h-11 rounded-md text-gray-500 transition duration-150 hover:bg-slate-50 active:bg-white'>
                            Edit Cart
                        </button> </Link>
